...
import { FloatingLabelsPassword,FloatingLabelsEmail } from '@components/forms/floating_labels/index.js'
                    ...
                    <Container className='mt-5'>
                        ...
                        <Form onSubmit={props.handleSubmit} noValidate validated={props.validated}>
                            ...
                            <Row className="justify-content-md-center">
                                ...
                                <Col lg="4">
                                    <p class="fs-3"> Enter your email:</p>
                                </Col>
                            ...
                            <Row className="justify-content-md-center">
                                ...
                                <Col lg="8">
                                    <FloatingLabelsEmail handleChange={props.handleChange} val={props.loginType} name="email"/>
                                </Col>
